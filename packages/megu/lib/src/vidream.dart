...
class Vidream extends StatefulWidget {
  ...
  /// The initial page to show when first creating the [Vidream].
  ///
  /// Defaults to 0.
  ...
  /// Animates the controlled [Vidream] to the next page.
  ///
  ...
  /// Animates the controlled [Vidream] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Changes which page is displayed in the controlled [Vidream].
  ///
  ...
  /// Animates the controlled [Vidream] from the current page to the given page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  @override
  _VidreamState createState() => _VidreamState();
}

class _VidreamState extends State<Vidream> with TickerProviderStateMixin {
  Timer timer;
